...
[![Build Status](https://travis-ci.org/Porthole-Project/Porthole.svg?branch=master)](https://travis-ci.org/Porthole-Project/Porthole)
[![Coverage Status](https://coveralls.io/repos/github/Porthole-Project/Porthole/badge.svg?branch=master)](https://coveralls.io/github/Porthole-Project/Porthole?branch=master)
[![Gitter](https://badges.gitter.im/Porthole-Project/Porthole.svg)](https://gitter.im/Porthole-Project/Porthole?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
This is a continuation of the [Plex-Board](https://github.com/scytherswings/Plex-Board) project I started a few years ago which
was essentially a revamp of a cool project ([Network-Status-Page](https://github.com/scytherswings/Network-Status-Page)) I had forked a while ago.
...
__Porthole__ is meant to help the users **and** administrators of a Plex server get a quick overview on the 
...
[Gitter](https://gitter.im/Porthole-Project/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link), or create a feature request ticket.
...
* [Porthole Wiki Homepage](https://github.com/Porthole-Project/Porthole/wiki)
* [Docker!!!](https://github.com/Porthole-Project/Porthole/wiki/Porthole-Docker-Installation-Guide)
...
5. `git clone https://github.com/Porthole-Project/Porthole.git`
...
10. __Porthole__ should now be installed!
...
2. Create an [issue](https://github.com/Porthole-Project/Porthole/issues/new) if you are having trouble. \
   Or you can ping me on [Gitter](https://gitter.im/Porthole-Project/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link)
...
[Gitter](https://gitter.im/Porthole-Project/Lobby?utm_source=share-link&utm_medium=link&utm_campaign=share-link) chat room. 
