...
class PlexServicesControllerTest < ActionController::TestCase
  ...
  test 'should get edit' do
    ...
    assert_select 'title', "Porthole | Edit #{@plex_service_one.service.name}"
  end

  test 'should get show' do
    get :show, params: {id: @plex_service_one.id}
    assert_response :success
    assert_select 'title', "Porthole | #{@plex_service_one.service.name}"
  end

  test 'should get all_plex_services' do
    get :all_plex_services
    assert_response :success
    assert_select 'title', 'Porthole | All Plex Services'
  end

  test 'should get new' do
    get :new
    assert_response :success
    assert_select 'title', 'Porthole | New Plex Service'
  end
