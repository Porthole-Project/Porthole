...
CREATE TABLE IF NOT EXISTS "services" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "dns_name" varchar, "ip" varchar, "url" varchar, "port" integer, "serviceable_id" integer, "serviceable_type" varchar, "description" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
